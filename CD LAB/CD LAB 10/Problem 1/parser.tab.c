...
{
       0,    33,    33,    35,    39,    44,    48,    52,    59,    66,
      72,    79,    86,    92,    99,   105,   111,   114,   119
};
#endif
...
static const char *const yytname[] =
{
  ...
  "NEWLINE", "$accept", "program", "statement", "expr", "term", "factor",
  "power", "primary", YY_NULLPTR
};
...
{
      -6,     0,    -6,    -6,     5,    -2,    -6,    -6,     9,    -1,
      -6,    -5,    -6,    -2,    -6,    13,    -2,    -2,    -6,    -2,
      -2,    -2,    11,    -6,    -1,    -1,    -6,    -6,    -6,    -6
};
...
{
       2,     0,     1,    17,    18,     0,     6,     3,     0,     9,
      12,    14,    15,     0,    18,     0,     0,     0,     5,     0,
       0,     0,     0,    16,     7,     8,    10,    11,    13,     4
};
...
{
       2,     3,    14,     3,     4,    21,    15,    19,    20,     5,
      13,     5,     0,     6,    22,    16,    17,    16,    17,    16,
      17,     0,    18,     0,    29,    23,    26,    27,    28,     0,
      24,    25
};

static const yytype_int8 yycheck[] =
{
       0,     3,     4,     3,     4,    10,     5,     8,     9,    11,
       5,    11,    -1,    13,    13,     6,     7,     6,     7,     6,
       7,    -1,    13,    -1,    13,    12,    19,    20,    21,    -1,
      16,    17
};
...
static const yytype_int8 yystos[] =
{
      ...
      19,    20,    21,     5,     4,    17,     6,     7,    13,     8,
       9,    10,    17,    12,    18,    18,    19,    19,    19,    13
};
...
yyreduce:
  ...
  switch (yyn)
    {
  case 4: /* statement: ID ASSIGN expr NEWLINE  */
#line 39 "parser.y"
                           {
        printf("%s = %s\n", (yyvsp[-3].id), (yyvsp[-1].addr));
        free((yyvsp[-3].id));
        free((yyvsp[-1].addr));
    }
...
#line 1174 "parser.tab.c"
  ...
  case 13: /* factor: power POW factor  */
#line 92 "parser.y"
                     {
        char *temp = new_temp();
        generate_code("^", (yyvsp[-2].addr), (yyvsp[0].addr), temp);
